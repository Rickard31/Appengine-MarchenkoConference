...
public class ConferenceApi {
	 ...
	 * @param profileForm
	 *            A ProfileForm object sent from the client form. because apparently
	 *            only one Entity argument is allowed
	...
	public Collection<Conference> getConferencesToAttend(final User user)
		...
		List<Conference> res = new ArrayList<Conference>(0);
		for (String key : keyStringsToAttend) {
			res.add(getConference(key));
		}
